...
CREATE TABLE IF NOT EXISTS loan_payments (
  ...
  CONSTRAINT fk_loan_payments_student FOREIGN KEY (student_id) REFERENCES students(id) ON DELETE CASCADE
);
...
CREATE POLICY IF NOT EXISTS "Allow all access to loans" ON loans FOR ALL USING (true);
CREATE POLICY IF NOT EXISTS "Allow all access to loan_payments" ON loan_payments FOR ALL USING (true);
CREATE POLICY IF NOT EXISTS "Allow all access to credit_score_rates" ON credit_score_rates FOR ALL USING (true);
