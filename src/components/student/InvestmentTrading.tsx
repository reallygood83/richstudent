...
export default function InvestmentTrading({ cashBalance, onTradeComplete }: InvestmentTradingProps) {
                  ...
                  <select
                    ...
                    onChange={(e) => {
                      ...
                      setBuyForm(prev => ({
                        ...
                        price: selectedAsset ? selectedAsset.current_price.toString() : ''
                      }))
                    }}
                  ...
                  >
                    ...
                    {assets.map((asset) => (
                      <option key={asset.id} value={asset.id}>
                        {asset.symbol} - {asset.name} ({formatCurrency(asset.current_price)})
                      </option>
                    ))}
                  </select>
                  {buyForm.asset_id && (
              ...
              {portfolio.length === 0 ? (
                ...
                <form onSubmit={handleSell} className=\"space-y-6\">
                  ...
                  <div className=\"space-y-2\">
                    ...
                    <select
                      ...
                      onChange={(e) => {
                        ...
                        setSellForm(prev => ({
                          ...prev,
                          asset_id: e.target.value,
                          price: holding ? holding.market_assets.current_price.toString() : ''
                        }))
                      }}
                      className=\"w-full p-2 border rounded-md\"
                      required
                    ...
                    {sellForm.asset_id && (() => {
                      const holding = getHolding(sellForm.asset_id)
                      return holding ? (
                        <div className=\"mt-2 p-3 bg-blue-50 rounded-lg\">
                          <div className=\"grid grid-cols-2 gap-2 text-sm\">
                            ...
                            <div>
                              ...
                              <span className={`font-medium ${holding.profit_loss >= 0 ? 'text-green-600' : 'text-red-600'}`}>
